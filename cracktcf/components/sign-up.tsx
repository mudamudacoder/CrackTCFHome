      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="text-center mb-10">
          <h2 className="text-4xl font-medium sm:text-5xl md:text-6xl">
            Sign up for a <span className="text-red-600 underline">free </span>trial today
          </h2>
        </div>
        ...
        <div className="md:flex md:justify-center md:space-x-8 md:items-start">
          <div className="mb-10 md:mb-0">
            <div className="text-center mb-6">
              <h3 className="text-4xl font-semibold">Trial Class</h3>
              <p className="text-6xl font-extrabold text-red-600">$0</p>
            </div>
            <p className="text-center text-gray-600 text-3xl">
          ...
          <div className="text-center">
            <div className="mb-6">
              <h3 className="text-4xl font-semibold">CLB 7 - 16 Week (4 months) Program</h3>
