  ...
  return (
    <div className="relative text-center py-12" style={{
      ...
      <div className="relative">
        <h2 className="text-8xl font-bold text-gray-800 mb-8">Boost your CRS Score with French</h2>
        <div className="flex flex-col md:flex-row justify-center items-center space-y-6 md:space-y-0 md:space-x-10 max-w-6xl mx-auto">
          <div className="space-y-4">
            <h3 className="text-3xl font-semibold text-gray-700">Without CLB 7 in French</h3>
            <p className="text-5xl font-bold text-red-600">425</p>
          </div>
          <div className="space-y-4">
            <h3 className="text-3xl font-semibold text-gray-700">With CLB 7 in French</h3>
        ...
        <div className="mt-6">
          ...
          <a href='https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/submit-profile/rounds-invitations/category-based-selection.html'
            target='_blank'
          ><button className="bg-orange-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full transition duration-300">
            Learn More
          </button></a>
        </div>
      </div>
